...
:mod:`~pyofficeeditor.excel._calc.dates`. A function reading a date takes
...
from pyofficeeditor.excel._calc.values import NUM, VALUE, Empty, ExcelError, Scalar, Value

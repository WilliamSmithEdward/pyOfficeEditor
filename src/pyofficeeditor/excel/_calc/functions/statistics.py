...
from pyofficeeditor.excel._calc.functions.aggregate import deviations, mean
...
from pyofficeeditor.excel._calc.precise import add, divide, multiply, square_root, subtract, summed
